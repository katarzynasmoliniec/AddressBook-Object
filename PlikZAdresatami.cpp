...
int PlikZAdresatami :: pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(string daneJednegoAdresataOddzielonePionowymiKreskami)
{
    ...
    int idAdresata = 0;
    idAdresata = MetodyPomocnicze :: konwersjaStringNaInt(MetodyPomocnicze :: pobierzLiczbe(daneJednegoAdresataOddzielonePionowymiKreskami, pozycjaRozpoczeciaIdAdresata));
    return idAdresata;
}
...
void PlikZAdresatami :: zaktualizujDaneWybranegoAdresata(Adresat adresat)
{
    ...
    edytujAdresataWPliku(idEdytowanegoAdresata, zamienDaneAdresataNaLinieZDanymiOddzielonymiPionowymiKreskami(adresat));
    cout << endl << "Dane zostaly zaktualizowane." << endl << endl;
}

void PlikZAdresatami :: edytujAdresataWPliku(int idEdytowanegoAdresata, string daneJednegoAdresata)
{
           ...
           if(idEdytowanegoAdresata == pobierzIdAdresataZDanychOddzielonychPionowymiKreskami(wczytanaLinia))
            {
                if (numerWczytanejLinii == 1)
                    tymczasowyPlikTekstowy << daneJednegoAdresata;
                else if (numerWczytanejLinii > 1)
                    tymczasowyPlikTekstowy << endl << daneJednegoAdresata;
            }
            else
            {
                if (numerWczytanejLinii == 1)
